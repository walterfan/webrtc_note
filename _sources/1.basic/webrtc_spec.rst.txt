...
参见 `RFC4566`_ Session Decscription Protocol

* RTP

参见 `RFC3550`_ Realtime Transport Protocols

* SRTP

参见 `RFC3711`_ Secure Realtime Transport Protocols
...
RFC8853: https://datatracker.ietf.org/doc/html/rfc8853
